...
def create_map(images_data):
    ...
    for img in sorted_image_data:
        ...
        if img.get("has_gps"):
            ...
            <b>Model</b> {img["camera_model"].replace('\x00',"")}<br>
            ...
            folium.Marker(location=loc, popup=popup,icon=icon_file,tooltip=f'{img['camera_model'].replace('\x00',"")} {img['datetime']}').add_to(m)
...
if __name__ == "__main__":
    data=extractor.extract_all('../images/nigga')
